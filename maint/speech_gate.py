...
#
#   python maint/speech_gate.py           what is held, and under whose permission
#   python maint/speech_gate.py --check   fail while a file sits under no granted source
#   python maint/speech_gate.py --bypass  answer the gate without satisfying it
#
