...
#
#   Usage:  python maint/get_deps.py [--update]
#
...
# be rebuilt from the public archive by anyone: data/salishan/get_papers.py fetches all 993 ICSNL
    ...
    for name, repository, why in WANTED:
        ...
        if repository is None:
            ...
            if name == "salishan_corpus":
                ...
                print("      python data/salishan/get_papers.py")
            continue
