...
#
#   python maint/citations/corpus_crossref.py              all three passes
#   python maint/citations/corpus_crossref.py --speakers   who the corpus rests on, and who is unnamed
#   python maint/citations/corpus_crossref.py --forms      language forms only
#   python maint/citations/corpus_crossref.py --prose      quoted paper text only
#   python maint/citations/corpus_crossref.py --context N  lines counted as beside a use
#
# WHY THIS EXISTS
#
...
def run_forms(out, context):
    ...
    if not forms:
        ...
        out.write("  run maint/corpus/verify_private_sync.py\n")
        return 2
