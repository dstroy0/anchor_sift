...
def main():
    ...
    checks = [
        ("Runs against voxels", "%d objects: every body's run lengths sum to its voxel count, %d aberrant"
    ...
    for title, meaning in checks:
        ...
        row += 58
    limits = [
        "Every positive body is a cell here: about 1,000 a frame against a published estimate of a few hundred.",
