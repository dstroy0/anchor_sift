...
Usage:
    python maint/source/readclean.py code   PATH [PATH ...]
    python maint/source/readclean.py blind  PATH [PATH ...] [--legend FILE] [--keep NAME,...]
    python maint/source/readclean.py claims PATH [PATH ...]
