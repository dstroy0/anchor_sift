...
#
#   python maint/speech_order.py            recompute the order and check it holds
#   python maint/speech_order.py --write    write the register in that order
#   python maint/speech_order.py --redraw   draw a new seed, which moves everybody
#
...
def write_register(path, notes, header, drawn, seed, out):
    ...
    with io.open(path, "w", encoding="utf-8", newline="\n") as handle:
        ...
        handle.write("# maint/speech_order.py in anchor_sift does all of them.\n")
        handle.write("#\n")
