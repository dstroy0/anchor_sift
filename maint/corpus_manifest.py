...
#
#   python maint/corpus_manifest.py            reconcile, and say what disagrees
#   python maint/corpus_manifest.py --write    rewrite the inventory from what is on disk
#   python maint/corpus_manifest.py --root D   work on the tree at D
#   python maint/corpus_manifest.py --bypass   answer the gate without satisfying it
#
...
def write_manifest(root, rows, out, name=NAME):
    ...
    with io.open(target, "w", encoding="utf-8", newline="\n") as handle:
        ...
        handle.write("# Rewritten by maint/corpus_manifest.py --write in anchor_sift.\n")
