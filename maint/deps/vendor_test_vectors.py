...
#
#   Usage:  python maint/deps/vendor_test_vectors.py [--keep-archives]
#
...
def _sibling_base():
    ...
    return os.path.dirname(os.path.dirname(os.path.abspath(common)))
...
def main():
    ...
    manifest = {
        "note": "Published SHA-256 vectors, vendored. Refresh with maint/deps/vendor_test_vectors.py.",
