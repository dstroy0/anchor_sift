...
#
#   Usage:  python maint/deps/get_deps.py [--update]
#
...
# be rebuilt from the public archive by anyone: maint/data/salishan/get_papers.py fetches all 993 ICSNL
    ...
    for name, repository, why in WANTED:
        ...
        if repository is None:
            ...
            if name == "salishan_corpus":
                ...
                print("      python maint/data/salishan/get_papers.py")
            continue
