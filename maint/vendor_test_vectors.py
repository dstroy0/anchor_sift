...
#
#   Usage:  python maint/vendor_test_vectors.py [--keep-archives]
#
...
def take_hmac_section(archive, stamp, manifest):
    ...
    header = ("# Extracted from HMAC.rsp, the [L=32] section only, by maint/vendor_test_vectors.py\n"
              "# Source %s\n# Archive sha256 %s\n\n" % (HMAC_URL, stamp))
...
def main():
    ...
    manifest = {
        "note": "Published SHA-256 vectors, vendored. Refresh with maint/vendor_test_vectors.py.",
