...
#
#   Usage:  python maint/data/salishan/corpus_script_extraction/extract_robertson.py
#
...
def main():
    ...
    step = 0
    # Whether the row above was a Chinook Jargon translation, which tells a literal
    ...
    for trimmed in lines:
        ...
        if found:
            ...
            # two stanzas. Closing the block here keeps footnote 30's abbreviation list out
    ...
    # token of the language the paper printed. For this one that means the whole analysis, its cited
