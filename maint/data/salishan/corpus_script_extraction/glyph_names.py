...
# exactly four hex digits, which keeps /uni0294w from being read as a name ending in w: the
...
# they sit on, the order Unicode wants and the order the extraction already has: page 30's
