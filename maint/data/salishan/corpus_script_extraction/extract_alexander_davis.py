...
#
#   Usage:  python maint/data/salishan/corpus_script_extraction/extract_alexander_davis.py
#
...
# the single quote, as the two Lyon papers needed, cost five translations here. The
...
# sign. Testing for that keeps a wrapped transcription line, a timestamp, a page number or a
