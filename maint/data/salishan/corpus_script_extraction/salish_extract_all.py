...
#
#   Usage:  python maint/data/salishan/corpus_script_extraction/salish_extract_all.py
#
...
#
# Every row carries where it came from: the paper, the page, and the line. A row that turns out to be a
# gloss line or a segmentation line can then be found and corrected against the source instead of guessed
