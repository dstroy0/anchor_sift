...
#
#   Usage:  python maint/data/fetch/fetch_language_corpora.py
#
...
# id, filename, what it is. Spread over families and centuries deliberately.
WANTED = [
    ...
    # Logographic. A character is a morpheme, and the symbols at character width are meanings and not
