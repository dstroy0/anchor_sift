...
#
# Fetch cookery books across several centuries, for Section 4.13 of theory/workbooks/anchor_sift.
#
#   Usage:  python maint/data/fetch/fetch_recipes.py
#
...
# on the page is the shape of the instruction with its content removed by time. That is the same
