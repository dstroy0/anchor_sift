...
# theory/anchor_sift.
#
#   Usage:  python maint/data/fetch/philologic_probe.py
#
# The collection splits into a public part and a restricted one, the way a shelf of novels still in
# copyright has to look. The public part is everything published before 1923 and is out of copyright,
