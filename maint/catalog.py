...
#
#   python maint/catalog.py            what is registered and what is not
#   python maint/catalog.py --assign   number the new ones and write it into their headers
#   python maint/catalog.py --check    fail where a header and the registry disagree
#
...
def write_registry(rows):
    with io.open(REGISTRY, "w", encoding="utf-8", newline="\n") as handle:
        ...
        handle.write("# Written by maint/catalog.py --assign.\n")
