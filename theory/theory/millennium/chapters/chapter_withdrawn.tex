...
with what killed it. That a reader can tell which statements elsewhere in these pages survived a
...
\textbf{Claimed.} That the forced case was ``occupied and contested,'' phrased as to put it
...
$[0,\tfrac12]$ for a real carrying no integrality structure. Agreement to $N$ digits is a bound
...
chance-coincidence rate. That the null needed conditioning on the arithmetic structure already
in the inputs.
...
\textbf{What killed it.} Searching wider. Both paths were repository-relative to the PQC tree and
had been resolved against anchor\_sift. Both files exist and every figure quoted from them was
