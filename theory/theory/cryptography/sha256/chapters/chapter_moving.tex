...
Sixteen lags per field, eight on each axis. The largest of them peaks near
...
\(2 \pi (f v) r / 32\). \(fv\) is the natural coordinate and \(v\) is a degenerate one: every
...
standing still & 2.19 & 3.50 & 2.25 & \textemdash{} \\
\bottomrule
\end{tabular}
\end{center}
...
\textbf{The phase channel is ceiling-limited.} Summing \(R\) unit vectors cannot exceed \(R\). The
statistic is bounded above by \(\sqrt{2R}\) whatever the data does, \(9.17\) at forty-two
rounds. The injected wave reads \(9.15\), which is saturation and not a measurement. Against a
null peak of \(4.66\) the channel has a factor of two of usable range. Discarding amplitude is a
