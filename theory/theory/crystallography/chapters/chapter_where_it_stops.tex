...
\textbf{Purpose:} State the boundary of the claim. Nothing here is quoted past what it supports.
...
Exact coordinates collide only where a deposit puts two sites at the same place. Nothing is lost that the deposit did not already carry. The limit was the reader's and it is gone with the reader that had it.
...
What the exactness rules out is a second uncertainty underneath the first. The instrument contributes nothing to the error. Whatever error remains is the deposit's and can be argued about on its own terms.
