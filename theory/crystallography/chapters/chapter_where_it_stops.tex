...
\section{One voxel, one atom}

At 0.25 angstroms two atoms can land on the same voxel and the later one overwrites the earlier. Nothing recovers the lost site. For the lattice period this is harmless, because the period is a property of the repeating arrangement and not of any particular site, but it means the grid is not the structure and should not be used as though it were.
