...
The \(\geq 18\) entries are the cube ceiling of the bench rather than a measurement, so what is proved is the separation and not the carry's absolute degree.
