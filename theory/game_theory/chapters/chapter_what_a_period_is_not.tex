...
\texttt{examples/\allowbreak{}games/\allowbreak{}6\_\allowbreak{}oracle/\allowbreak{}sturmian\_\allowbreak{}convergents.\allowbreak{}py},
...
rank 8 of 63, and the lowest of all of them is one of the two. So where the mechanism does not
account for the answer, the answer is also the one the detector was least sure of.

\(\pi\) is the row that shows the mechanism rather than merely fitting it. Its continued fraction
has a 292 in it early, so its convergent denominators jump from 7 to 106, and the detector holds 7
across six consecutive windows before moving at all. A slope whose approximations improve slowly,
...
at a single window is, on this evidence, unverified rather than wrong, and the crystallography rows
are safe for a reason that is about the corpus and not about the reader: a lattice has a period for
the reported number to be.
