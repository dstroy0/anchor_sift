...
an entry here is not a confession and should not be read as one. Refuted entries are
...
\begin{itemize}
  \item \textbf{The cross-language ordering result.} Montemurro and Zanette,
    \emph{Universal Entropy of Word Ordering Across Linguistic Families}, PLoS ONE 6(5):e19875, 2011.
