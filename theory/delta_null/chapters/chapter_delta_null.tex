...
\addlinespace[0.4em]
\texttt{bench\_ancorae\_lattice.c} &
  whether Proposition 1 survives off the line &
  candidates, refusals \\
\addlinespace[0.4em]
\texttt{bench\_ancorae\_entropy.c} &
...
\noindent\textbf{The Finnish row is a genre confound and not a property of Finnish.} Every other text here is running prose and the \_Kalevala\_ is verse in strict trochaic tetrameter, compiled from oral songs. Its lines are more regular than its words and the detector finds the line. Replacing it with Finnish prose settles it:
