...
The quantum number $n$ is an exact integer. Two neighboring orbits differ by
\[
...
structure, the Lamb shift and every later correction. The model error dominates the constants'
