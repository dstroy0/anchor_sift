...
state, so electrons accumulate into successive states instead of piling into the lowest, and that
...
keeps no exclusion. The recurrence survives neither, so it is in the order Pauli fills the shells and
