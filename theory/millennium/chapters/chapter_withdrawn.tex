...
Stated twice, to two different sessions, and used to argue that the problem remained open after the
...
leaned on a page's categorization as though it were evidence about the mathematics rather than
...
\textbf{What killed it.} It was derived rather than drawn. Withdrawn by its author, who recorded
...
\textbf{Why it is in this ledger although it was never reported.} Because it was one step from
