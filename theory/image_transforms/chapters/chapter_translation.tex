...
\]
so the normalized cross power spectrum is a pure phase whose inverse transform is a delta at the
...
stays in the field of view. Video stabilization does the same for a hand held camera. In every case
the translation of the whole view is removed before any object is tracked, the order the
