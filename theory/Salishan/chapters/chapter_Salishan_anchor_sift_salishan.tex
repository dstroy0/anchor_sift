...
The thirteenth, \texttt{1975\_\allowbreak{}Hilbert\_\allowbreak{}Hess}, is read and has no reader yet, so \texttt{reader\_\allowbreak{}check} holds it ungraded instead of counting it. The six languages are the ones with a pure corpus on disk; two of the thirteen papers are in languages that have no anchor.
