...
\textbf{Purpose:} Say how wrong the pure corpus could be, from what the checks have actually seen, and say what the number rests on. \textbf{Scope:} \texttt{data/\allowbreak{}salishan/\allowbreak{}corpus\_\allowbreak{}derivation.\allowbreak{}py}, which writes this file, and the three checks it reads.

Rewritten by \texttt{python data/\allowbreak{}salishan/\allowbreak{}corpus\_\allowbreak{}derivation.\allowbreak{}py} after every change to a hand extraction. Nothing in it is typed by hand.
...
A paper contributes trials only where its extracted text is what the page prints. The others are checked against a damaged source, so their disagreements measure the source and not the table. \texttt{refs.\allowbreak{}md} names each of them.
...
The last 3 papers agree to 1 significant figure.
...
\textbf{Compiled By:} dstroy0 (Douglas Quigg) <dquigg123@gmail.com> \textbf{Generated by:} \texttt{data/\allowbreak{}salishan/\allowbreak{}corpus\_\allowbreak{}derivation.\allowbreak{}py}
