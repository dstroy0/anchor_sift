...
\texttt{ICSNL58\_\allowbreak{}Givens\_\allowbreak{}Hall\_\allowbreak{}final} & 178 & 896 & 97 & 161 & 2 & yes \\
...
17 of the 25 hand extractions are checked against a sound source. Together they put 15155 distinct written forms and 7451 language tokens through the two directions.
...
\midrule
a form written that the paper does not hold & 97 & 15155 & 0.0064 \\
...
No digit has settled. The bound falls with every paper because every paper adds trials and none has yet added a failure. Quoting 5.42e-10 as though the 85 meant something would be reporting the format. What the table says is that the extraction is still buying accuracy at the rate of about one order of magnitude every 11.1 papers, and the digit to report will settle when that stops.
...
\midrule
a form written that the paper does not hold & 15155 & 885230 & 3.39e-06 \\
...
Reading all 993 papers of the archive, and finding nothing wrong in any of them, takes the joint bound from 5.42e-10 to about 1.26e-16. That is 10 orders of magnitude short of 1e-26.
