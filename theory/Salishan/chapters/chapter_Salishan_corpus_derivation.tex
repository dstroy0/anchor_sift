...
A paper contributes trials only where its extracted text is what the page prints. The others are checked against a damaged source, so their disagreements measure the source and not the table. The references chapter names each of them.
