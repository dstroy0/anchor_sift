...
William W. Elmendorf, Word Tabu and Change Rates, ICSNL 2. Thirteen languages are cited in it and Twana is its subject, so that is the language named here; every row carries its own language in the who column. No speaker is named anywhere: the forms come from Boas and Haeberlin 1927, Krueger 1967, McIlwraith 1948, Walters 1938 and Ray 1932, from Warren Snyder's Suquamish list and Wayne Suttles' Squamish field notes, and from Elmendorf's own field data. This typescript writes its uvular as x under a dot where 1975\_Hilbert\_Hess writes it under a caron, and 1967\_Hess agrees with it, which is two papers of one conference against one of a later year. One mark is unresolved and marked so in the table: a short raised stroke over the s of the Columbia ska'u on page 7, which is not the wedge the Upper Chehalis sča'u carries two words earlier.
