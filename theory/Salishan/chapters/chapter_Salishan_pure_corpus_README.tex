...
\textbf{Purpose:} Find whose language is in this corpus, and which table holds it. \textbf{Scope:} every \texttt{.\allowbreak{}oracle.\allowbreak{}tsv} in the closed corpus, which reaches this tree under \texttt{build/\allowbreak{}oracles} through \texttt{maint/\allowbreak{}private\_\allowbreak{}sync.\allowbreak{}py}
