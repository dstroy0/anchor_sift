...
#
#   python data/salishan/paper_supervisor.py --plan          write the work list
#   python data/salishan/paper_supervisor.py                 what is held and what is not
#   python data/salishan/paper_supervisor.py --adopt DIR     take PDFs from a download directory
#   python data/salishan/paper_supervisor.py --fetch         fetch what is missing, where it can
#   python data/salishan/paper_supervisor.py --remaining     print the addresses still needed
#
...
def write_plan(rows, out):
    ...
    with io.open(PLAN, "w", encoding="utf-8", newline="\n") as handle:
        ...
        handle.write("# Written by data/salishan/paper_supervisor.py. Safe to delete and rebuild.\n")
        handle.write("#\n")
