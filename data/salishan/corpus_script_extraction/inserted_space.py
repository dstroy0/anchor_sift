...
#
# The grain nearly every paper here carries: a space left after a stacked diacritic.
#
...
# wrote K̓weswapáw̓ down as the single word it is, and reader_check.py then reported 91 of that paper's
...
# class keeps it out without anyone having to remember to exclude it.
...
#
# This separates the general grain from the wider one. A paper whose own layout
