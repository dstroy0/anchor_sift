...
#
#   Usage:  python data/salishan/hand_extraction/pure_corpus_index.py
#
...
def main():
    ...
    with io.StringIO() as handle:
        ...
        handle.write("Written by `data/salishan/hand_extraction/pure_corpus_index.py` "
