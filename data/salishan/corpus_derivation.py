...
#
#   Usage:  python data/salishan/corpus_derivation.py
#
...
def main():
    ...
    with io.StringIO() as handle:
        ...
        handle.write("**Scope:** `data/salishan/corpus_derivation.py`, which writes this "
                     "file, and the three checks it reads.\n\n")
        handle.write("Rewritten by `python data/salishan/corpus_derivation.py` after "
        ...
        handle.write("`data/salishan/word_web/word_web.py` joins every form in the hand "
        ...
        handle.write("**Generated by:** `data/salishan/corpus_derivation.py`\n")
