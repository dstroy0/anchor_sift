...
# 4.2 of theory/workbooks/anchor_sift.
#
...
def measure(values):
    ...
    The curve decides whether the sum over every width exists. A term that decays leaves a total
...
def main():
    ...
    # real correlation at length from the arithmetic of estimating it.
