...
# A language whose name appears in a corpus name, which lets a swap be reported by name
NAMED = tuple(FINGERPRINTS)


def wrapped(text):
    """Whether the lines look set to a fixed width, which comes from the publisher."""
