...
# each other for reasons that have nothing to do with the language, and the 83.1 percent measured
...
from measure.web import squashed as squashed_web, web  # noqa: E402
from oracle.language.families import PARALLEL as MORE, FAMILY  # noqa: E402
...
def squashed(text):
    """The web read at every code width at once, over one alphabet shared by every language."""
    return squashed_web(text, as_codes, WIDTHS)
