...
# of theory/workbooks/anchor_sift.
#
...
# form carries, the count the language holds regardless of how often each is used.
#
# What this cannot see: a treebank records the reading a word has in the sentence it appeared in, not
# every reading it could have. A form is ambiguous here only if the corpus happened to use it both
