...
# it this is, for Section 4.13 of theory/workbooks/anchor_sift.
#
...
# could have. Every corpus is cut to one size before the columns are set beside each other for that reason.
...
def main():
    ...
    for language, used, category, inflection, whole, mixed in rows:
        out.write("  %-12s %-27s %-11.4f %-11.4f %-11.4f %.4f\n"
                  % (language, CAPITALIZES.get(language, ""), category, inflection, whole, mixed))
