...
# most the tenth power of their average. A varying profile always produces a smaller product than an
...
# every reading it could have. A longer corpus finds more ambiguity, and languages of unlike corpus size
