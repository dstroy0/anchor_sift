...
# and Baltic neighbors. Hungarian sits in central Europe surrounded by Slavic, German and Turkic, two
# thousand kilometers from its nearest relative, and has been for a thousand years. They are one family by
# descent and share almost nothing by contact, and the relationship took a long argument to establish
...
# neighbors, German or Polish or Czech, and Finnish goes to Swedish, which it did once already in an
...
from representation.text.corpus import SKIP  # noqa: E402
