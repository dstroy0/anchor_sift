...
from representation.text.shared_alphabet import as_codes  # noqa: E402
...
def main():
    ...
    # and this one covers 33 across many more families. A change in the result would otherwise not be
