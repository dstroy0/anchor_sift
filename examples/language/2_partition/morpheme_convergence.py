...
# Catalog: LNG-2-003
#
# Compare languages at the unit that carries meaning, for Section 4.13 of theory/workbooks/anchor_sift.
#
...
#
# So the alphabetic languages are read at word width, the closest unit to a morpheme that can be
