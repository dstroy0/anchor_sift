...
# theory/anchor_sift.
#
#   Usage:  python analysis/survey/paper_slice.py icsnl2016 203-224 vaneijk
#
...
#
# Each paper is therefore cut out at its own page boundaries and written as its own file, which can be read
