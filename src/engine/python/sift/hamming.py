...
#
# Why this is a sift-stage object and not a transform. A codeword must satisfy three parity checks;
...
# by a theorem and not by luck. That makes their agreement a check on the two implementations, not
