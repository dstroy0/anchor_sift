...
Errors are one directional. A discrepancy is always an over count and is therefore detectable
without knowing the answer.

What belongs here: the C kernel, its dispatcher, and the Python that drives them. What does not:
anything that scores a corpus, which is measure.
"""
