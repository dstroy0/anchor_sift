...
# allows that. A Vietnamese syllable carries six meanings under six tones. Removing the marks
...
# decides it: two unrelated passages of Vietnamese sit 0.0874 apart. Deleting the tone makes a
...
def every_mark(text):
    ...
    Stripping all of a language's marks is what the other languages get. The comparison is one
