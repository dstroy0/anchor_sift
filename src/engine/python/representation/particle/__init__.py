...
"""The fundamental particles as a subject: each one an exact set of quantum numbers, no mass.
...
subject reads, the three generations that recur and the per-generation charge sum that vanishes, is in
the exact numbers alone.
"""
