...
#
# Whether a sample is an outlier, decided by the spread its own neighbors show and not a picked
# threshold.
#
...
#
# This inherits the Hampel breakdown honestly instead of hiding it: two impulses in one window let one
