...
"""The departure of an object from its own reference.

Every quantity here is a distance and none is a value. A dispersion of 0.28 says nothing; the same
dispersion against a shuffle of the same bytes says the positions carry something. A measure that
