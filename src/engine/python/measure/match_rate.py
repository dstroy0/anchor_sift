...
# order while a text grows in a line. From order five most blocks have been seen once or never
...
# The longest match the search will bracket. A text's matches are short. The search doubles to
