...
#
#   Usage:  python src/engine/python/instrument/english_sift.py <paper stem> [more stems]
#           python src/engine/python/instrument/english_sift.py --check
#
...
def counts_of(texts):
    """Byte-pair counts over a body of text, the squash of method section 1."""
    held = {}
    total = 0
    for one in texts:
...
def check(out, counts, total):
    ...
    the control: the .pure.txt files hold target-language speech alone, and the N spans
