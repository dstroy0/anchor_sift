...
| day | line | entry |
|---|---|---|
| 2026-09-02 | 347 | No completeness. |
| 2026-09-02 | 350 | Three corollaries. |
| 2026-09-02 | 353 | Collision entropy is permutation invariant, so it cannot detect an arrangement. |
| 2026-09-02 | 360 | What is derivable here and what is not falls exactly on the line between the two propositions. |
| 2026-09-02 | 377 | The shuffle is the maximum entropy background, which is why it cannot be wrong. |
| 2026-09-04 | 382 | Exactly one distribution maximizes entropy under a given constraint, and that is where the finality comes from. |
| 2026-09-04 | 392 | That reference is necessarily memoryless, which is why the memoryless control returns 1.00 and is not a baseline anybody chose. |
| 2026-09-04 | 410 | The permutation null and the memoryless control are not the same object, and the difference is finite sample. |
| 2026-09-02 | 417 | The maximum entropy domain is the best case for this filter, so $2^{-H_2}$ per anchor is a floor. |
| 2026-09-02 | 429 | It is also the largest difference obtainable. |
| 2026-09-02 | 448 | Ownership of the three guarantees. |

**Measured, and holding**

| day | line | entry |
|---|---|---|
| 2026-09-02 | 485 | Collision entropy is close to a constant for a language, so the quantities derived from it are too. |
| 2026-09-02 | 502 | It does not survive a change of source, so it is not a property of the language. |
| 2026-09-02 | 515 | Corruption is detectable from the histogram, and windowing the histogram locates it. |
| 2026-09-04 | 531 | The same test runs at every window and does not stop where the estimator breaks. |
| 2026-09-02 | 540 | An unnamed quantity in the halving ladder. |
| 2026-09-02 | 593 | How many anchors to place is the log of the domain in the effective alphabet. |
| 2026-09-02 | 601 | The cut per anchor is the constant Section 4.4 names, checked without fitting. |
| 2026-09-02 | 609 | A language carries constants of its own, and the arrangement measure is not one of them. |
| 2026-09-02 | 629 | That finding is published and belongs to Montemurro and Zanette. |
| 2026-09-02 | 641 | The rare half also departs from the null on a second source and in four more language families. |
| 2026-09-02 | 652 | The published semantic primes are not the frequent half, and they divide along the same line it does. |
| 2026-09-02 | 670 | The rare half departs from the null in every kind of writing, and the frequent half does not. |
| 2026-09-02 | 684 | Folding line endings is right for prose and wrong for source, and it moved one measure and not the other. |
| 2026-09-02 | 696 | In a formal language the human layer is measurable because it is definitionally what the compiler discards. |
| 2026-09-02 | 704 | The case channel is community convention and it does not separate formal languages from prose. |
| 2026-09-02 | 714 | The language labels on that source are not reliable and the ones carrying findings were checked. |
| 2026-09-02 | 724 | VHDL is the strongest case of a convention with no machine content, because the language cannot see it. |
| 2026-09-02 | 736 | The control that was missing all along: a structured domain with no author and no selection. |
| 2026-09-02 | 750 | Nor is the signature human, on the fairest comparison available. |
| 2026-09-04 | 767 | The slice was wrong for a vocalization and correcting it changes the answer. |
| 2026-09-02 | 779 | The band where much animal communication happens is absent from the recordings by construction. |
| 2026-09-02 | 788 | Recorded for the band instead of despite it, the blue whale is the furthest from the null of anything measured here. |
| 2026-09-02 | 809 | On a continuous irregular domain the construction as implemented finds nothing, and the matcher is why. |
| 2026-09-02 | 831 | Corrected, it works, and the correction took two steps because the first null deleted the wrong property. |
| 2026-09-02 | 842 | The reading of that result is wrong and the proof of it refuted the rule it produced. |
| 2026-09-02 | 861 | A picture read as a sequence returns its own width, and the construction was already written for it. |
| 2026-09-02 | 882 | On a board layout the same residue is a grid setting, and it separates two tool communities. |
| 2026-09-02 | 906 | What survives that correction in the frequent half is formatting. |
| 2026-09-02 | 912 | The cell rarest rule holds across kinds of writing. |
| 2026-09-02 | 918 | The product rule error is a measurement and not only a defect. |
| 2026-09-02 | 925 | The best filter measured is the rarest symbol inside each cell, and it is not the rule in use. |
| 2026-09-02 | 934 | The product rule fails in the tail and not in the middle, and reporting it as a mean hid that. |
| 2026-09-02 | 942 | Sizing from the measured pair helps the tail and not the typical case. |
| 2026-09-02 | 950 | The sizing error distribution, by quantile, and what a buffer would have to hold. |
| 2026-09-02 | 966 | What cell selection buys has a peak and then gives it all back. |
| 2026-09-02 | 972 | The tail is the needle recurring in the corpus, and placement does not reach it. |
| 2026-09-02 | 979 | There are two structure meters here operating at different spans, and they agree. |
| 2026-09-02 | 988 | Collision entropy cannot see structure, which is why the null had to exist. |
| 2026-09-02 | 994 | Predicting the aggregate rate and predicting one search are different problems. |
| 2026-09-02 | 999 | The product rule is accurate where it does not matter and wrong where it is needed. |
| 2026-09-02 | 1004 | Where the anchors are placed changes the sizing more than which symbols they are. |
| 2026-09-02 | 1012 | On a perfectly periodic domain the placement rule stops mattering. |
| 2026-09-02 | 1018 | How far a vocabulary spreads across subjects is measurable, and it is the one scale here with resolved bands. |
| 2026-09-02 | 1032 | A cipher cannot remove what this measure reads unless it spends key equal to the message. |
| 2026-09-02 | 1041 | Subsampling attenuates by a known factor. |
| 2026-09-02 | 1047 | One quantity does three jobs. |
| 2026-09-02 | 1050 | Five instruments agree on the zero information object, and that is one assumption held five times. |
| 2026-09-02 | 1057 | The symbol width was never justified and it is not free. |

**Measured, and not holding**

| day | line | entry |
|---|---|---|
| 2026-09-02 | 1077 | No drift rate was obtained, over three designs that each lost to a different confound. |
| 2026-09-02 | 1086 | What that work did establish is a floor and a ceiling with nothing between them. |
| 2026-09-02 | 1092 | The pattern across all seven is one sentence. |
| 2026-09-02 | 1096 | Said as state: one entry is a table walk and six are memory. |
| 2026-09-04 | 1105 | Why the center of mass row loses, and it is the equilibrium argument arriving from the other side. |
| 2026-09-04 | 1133 | Where the constant is given, the method works immediately, and that is what separates chemistry from language here. |
| 2026-09-04 | 1148 | Where the substrate is indifferent, the whole of the departure from maximum entropy is intention, and three measurements in this document are that one measurement. |
| 2026-09-04 | 1181 | Said in one line: ask a question loaded with what you are certain of, and read what comes back. |
| 2026-09-04 | 1189 | What is universal here is the soundness, and it is universal because it is deductive. What is not universal is the reading, and that is Proposition 2. |
| 2026-09-04 | 1219 | The scope stated as limits, which is the form a reader should be handed. |
| 2026-09-04 | 1231 | What the limits do not exclude is an absence. |
| 2026-09-04 | 1237 | A thermodynamic argument for universal yield is available and it is about the wrong system. |
| 2026-09-04 | 1247 | The span across domains is the claim, and it is one construction and not a family of them. |
| 2026-09-04 | 1272 | On telling a human apart, the refuted claim and the supported one are not the same claim, and conflating them understates what is here. |
| 2026-09-04 | 1289 | Which means the signature is read as an inverse, and reading it any other way is reading the center. |
| 2026-09-04 | 1308 | A lattice is measured and a protein is measured, and they are not the same result. |
| 2026-09-04 | 1316 | Real crystals are read exactly, with published ground truth, and that is the strongest row here. |
| 2026-09-04 | 1326 | A protein and a crystal are the same object to this construction, and the difference in the two results is the instrument and not the domain. |
| 2026-09-04 | 1344 | Why it crosses the physical and the conceptual is the center-of-mass argument, and that is the whole of the mechanism. |
| 2026-09-04 | 1364 | Posit: the departure has a band, and a master works inside it. |
| 2026-09-04 | 1379 | They found it without any of this, which is the part that makes it worth recording. |
| 2026-09-04 | 1401 | A symbol a bad digitization dropped is recoverable from the distribution, and the document supplies its own answer key. |
| 2026-09-04 | 1415 | Inconsistent damage corrects itself and systematic damage does not, and that is the whole of when this works. |
| 2026-09-04 | 1436 | Two things that follow and that nobody has run. |
| 2026-09-04 | 1456 | Partial knowledge of the boundaries is enough, and that is Proposition 1 and not a new claim. |
| 2026-09-02 | 1469 | Where the one winning mechanism breaks, and why it is the same mechanism. |
| 2026-09-02 | 1477 | Where to branch between the two arrangements is derivable and lands at the effective alphabet. |
| 2026-09-02 | 1494 | That makes the branch decidable at run time from two cheap numbers. |
| 2026-09-02 | 1499 | The advantage between the two arrangements has a minimum and a maximum, both measured. |
| 2026-09-02 | 1510 | The needle is drawn from the corpus, so the benchmark answers an easier question than the one posed. |
| 2026-09-02 | 1520 | Correctness is measured in thirteen geometries and speed in one, and that one is the dominated case. |
| 2026-09-02 | 1532 | Why the rare anchor loses on a line. |

**Measured while chasing a want, and bearing on the design**

| day | line | entry |
|---|---|---|
| 2026-09-02 | 1539 | The vectorized cost model, measured and much smaller than derived. |
| 2026-09-02 | 1544 | A long search is verification bound. |
| 2026-09-02 | 1550 | Both propositions are now measurements and not only arguments. |
| 2026-09-02 | 1557 | The one directional error is a control signal. |
| 2026-09-02 | 1562 | A threshold on shift agreement needs a permutation null and not a formula. |
| 2026-09-02 | 1568 | The Finnish outlier was a genre confound of mine, not agglutination. |
| 2026-09-02 | 1575 | The symbol width was chosen by habit, and a Greek text is where that showed. |
| 2026-09-02 | 1581 | Vocabulary compression separates a translation from a composition. |
| 2026-09-02 | 1586 | Exact matching cannot see an inflected formula, so epic register went undetected. |
| 2026-09-02 | 1591 | The most regular thing in a text file is almost never the language. |
| 2026-09-02 | 1596 | A boundary has to be regular enough to find and irregular enough to locate with. |
| 2026-09-02 | 1603 | The pattern free detector finds periodicity and nothing else. |
| 2026-09-02 | 1607 | A stride calibrated on one known pattern does not transfer. |
| 2026-09-02 | 1615 | The failure was not where it was flagged. |

**Posits about the method, which fell out of the corrections and are not tested**

| day | line | entry |
|---|---|---|
| 2026-09-02 | 1672 | A constructed null deletes one property and it has to be the one being asked about. Proofed and refuted. |
| 2026-09-02 | 1690 | Two instruments are in use here and they keep being reported as one. |
| 2026-09-02 | 1699 | One representation for every corpus, reduced by a sum over vectors. Built, run over 273 corpora, and it does not replace the shift detector. |
| 2026-09-02 | 1718 | The volume has no dimension to assign, and assigning one was the defect behind the picture failure. |
| 2026-09-02 | 1733 | The numbering given to the symbols was suspected and cleared, except on pictures where it is the point. |
| 2026-09-02 | 1740 | The two instruments are not measuring one quantity, and that part is settled by construction and not by a number. |
| 2026-09-02 | 1747 | The explanation offered for that split was wrong and its own test refuted it. |
| 2026-09-02 | 1754 | What singles those corpora out is how long they stay near a value, not how small their steps are. |
| 2026-09-02 | 1776 | Abruptness orders the magnitude inside art and inverts outside it, at rho 0.786 over seven paintings, which is not enough paintings. |
| 2026-09-02 | 1794 | The high frequency part of a painting was called camera noise and it is not, which reverses the conclusion drawn from it. |
| 2026-09-02 | 1804 | The exponent of the power against frequency is the first quantity here that holds still, and every earlier statistic had a scale inside it. |
| 2026-09-02 | 1820 | A plane goes through one dimension when the coordinates are interleaved, and the exponent halves. |
| 2026-09-02 | 1830 | The squashing works at any number of dimensions, and it was checked against fields whose exponent was put in by hand. |
| 2026-09-02 | 1851 | Under half of that shortfall belongs to the curve and the rest is what one dimension cannot hold. |
| 2026-09-02 | 1860 | A line through a set carries how many dimensions the set has, and it took two failures to measure it. |
| 2026-09-02 | 1879 | The exponent identifies a family and rebuilds nothing, which is this document's own first proposition turning up as a measurement. |
| 2026-09-02 | 1893 | Saying that where each frequency sits costs as much as the set was too strong, and it confused needing every angle with needing every angle exactly. |
| 2026-09-02 | 1912 | Text has no approximate representation at all, and the three bit result on pictures does not carry to it. |
| 2026-09-02 | 1923 | Quoting the coefficient in levels compares alphabets and not languages, and dividing by the range each alphabet occupies is what makes them comparable. |
| 2026-09-02 | 1942 | Which symbol follows which identifies a language where every scalar failed, and its mistakes are the language families. |
| 2026-09-02 | 1951 | Whether the information in a text closes at a finite order is not settled here, and the reading that appeared to settle it was measuring its own sample size. |
| 2026-09-02 | 1968 | What a text gains at each distance describes the text and not the language, and it is twice as much a property of where the text came from. |
| 2026-09-02 | 1991 | Read by matching instead of by counting, the text has not closed at a quarter of a million characters. |
| 2026-09-02 | 2008 | That null was the wrong one for the question and the right one gives the same answer. |
| 2026-09-02 | 2034 | Where the reading stops working is now measured instead of guessed, because the shuffle has an answer that is arithmetic. |
| 2026-09-02 | 2060 | A dirty corpus does not give a slightly wrong answer, it gives a confidently inverted one, and it has happened twice here. |
| 2026-09-03 | 2077 | The best test here was assembled out of the failures before it and could not have been designed first. |
| 2026-09-02 | 2095 | Every bound put on a quantity in this work has had to be taken back off, and the reading improved each time it was. |
| 2026-09-02 | 2120 | The reading belongs to the language by a margin of about seven percent, and this bounds every language result in this document. |
| 2026-09-02 | 2137 | Being a procedure leaves no mark here that being formally written does not already leave. |
| 2026-09-03 | 2158 | Every negative result in this section is ambiguous in a way the positives are not, and they have all been written as though they were not. |
| 2026-09-03 | 2174 | The oldest continuous language traditions on earth are outside this work entirely, and two separate things put them there. |
| 2026-09-02 | 2190 | Everything measured in this work is the writing of people who were taught to write. |
| 2026-09-02 | 2197 | Matched across two works that share nothing, what survives is the family and not the language. |
| 2026-09-02 | 2214 | Every cross language reading in this work compared different books, and holding the content fixed turns out to cost the family result almost nothing. |
| 2026-09-02 | 2237 | One binary alphabet carries every script at a small cost, once the codes line up with the characters. |
| 2026-09-02 | 2255 | Comparing the binary webs at one width compared different resolutions against each other, and reading every width at once recovers half of what that cost. |
| 2026-09-02 | 2273 | It is not sound enough to be a first pass, which is what it was reached for. |
| 2026-09-03 | 2286 | Of what separates two German books, the author is worth 11 percent, the century 1 percent, and the book itself 88. |
| 2026-09-03 | 2296 | The reading is not one reading, because a character is a morpheme in some writing and a fragment of one in the rest. |
| 2026-09-03 | 2313 | Tone is the first thing measured here that clears the floor everything else sank under. |
| 2026-09-03 | 2331 | Repeated outside the family, the decomposition holds. |
| 2026-09-03 | 2340 | Three numbers beat four thousand at finding a Japanese writer, by nearly five to one. |
| 2026-09-03 | 2350 | Every structural result in this section was measured on one branch of one family. |
| 2026-09-03 | 2363 | Across three centuries of one language, with dates nobody here chose, time leaves a mark of about five percent. |
| 2026-09-03 | 2383 | Dividing the frequencies out of the reading compresses every distance toward the average and does not separate script from structure. |
| 2026-09-03 | 2404 | A writer is found at the word and not at the character, which is the same split the languages showed one level down. |
| 2026-09-03 | 2426 | Every language carries more than one reading per written word, and a walk through a sentence multiplies possibilities and cannot collapse. |
| 2026-09-03 | 2438 | The prediction that went with this was backwards and the correction is the finding. |
| 2026-09-03 | 2450 | Words for sounds follow the border and not the family. |
| 2026-09-03 | 2472 | Read as sounds instead of letters the pattern holds and the effect halves. |
| 2026-09-03 | 2491 | The families survive losing the alphabet entirely, and the claim below that they do not is wrong. |
| 2026-09-03 | 2506 | Most of what this reading calls naming a language is matching an alphabet. |
| 2026-09-03 | 2532 | Mining the field's own settings for language constants does not work from abstracts, and the first result that looked like it worked was noise. |
| 2026-09-03 | 2553 | Run against every task here, the square wins two of four by margins the size of the noise, and the character frequencies alone come within three points of it. |
| 2026-09-03 | 2572 | Twenty one numbers do what four thousand were doing. |
| 2026-09-03 | 2592 | Cut down to two symbols the relationship still shows, and what is left is word length. |
| 2026-09-03 | 2611 | The one clean success was challenged on its spelling and survived. |
| 2026-09-03 | 2624 | Given a close pair with nothing in the way, the reading finds it, and that fixes how far it reaches. |
| 2026-09-02 | 2645 | With the language held fixed and only the characters changed, the reading moves by twice what changing nothing moves, and where a text came from moves it more than either. |
| 2026-09-03 | 2669 | A family separated by an ocean is found, and the same test loses a relative three times older, which puts the depth limit on both sides of one run. |
| 2026-09-02 | 2689 | On the family built to tell descent from contact, the reading follows contact. |
| 2026-09-02 | 2712 | On a family whose branchings are ordered, the reading returns the opposite of the family, and that weakens the European result badly. |
| 2026-09-02 | 2736 | The inversion was untranslated English in the files, and cutting each to its own script brings the family back. |
| 2026-09-02 | 2752 | What remains after cleaning is real and is about the writing. |
| 2026-09-02 | 2783 | Grouping the languages by those squares returns the families, and the tree it is scored against is argued and not measured. |
| 2026-09-02 | 2791 | Greek sitting nearest Hebrew was called a script artifact here and it is neither an artifact nor a miss. |
| 2026-09-02 | 2799 | One of the four Greek texts is a Greek to English lexicon and had been standing in every Greek reading in this work. |
| 2026-09-02 | 2813 | The generated corpora mostly stay outside the languages and the kinds are not cleanly separated. |
| 2026-09-02 | 2829 | No quantity measured here identifies a language, and the coefficient is among the weaker ones at it. |
| 2026-09-02 | 2851 | Reading the alphabetic languages at word width makes it worse, and what it separates them by is morphology. |
| 2026-09-02 | 2862 | The coefficient only becomes a property of the corpus once it is taken at the numbering it converges to. |
| 2026-09-02 | 2882 | The spread of the values is the whole of it, and the generating parameters reach the result only through that one number. |
| 2026-09-02 | 2905 | A protein represented by its bonds in assembly order returns the chemistry, and two earlier representations of the same molecules returned nothing because each discarded the thing that carries it. |
| 2026-09-02 | 2921 | The reader used everywhere else in this work cannot see that period, and the reason is structural. |
| 2026-09-02 | 2940 | It does not work on proteins, and the prediction that it would was wrong. |
| 2026-09-02 | 2961 | What the interleaved curve loses is what carries the count, and the two are the same property. |
| 2026-09-02 | 2981 | The ordering is stable under a sixteenfold coarsening, at rho 0.893, so it is not a reading of the sampling. |
| 2026-09-02 | 2988 | Print the content and not only the statistic. Proofed as an audit, upheld, and it demonstrated itself on its own output. |
| 2026-09-02 | 3004 | The quantities here are heavy tailed by default, and a mean and a deviation need the distribution checked first. Proofed on the core measure, upheld in practice and wrong in its description. |
| 2026-09-02 | 3017 | The shape of that distribution is itself a second detector. |
| 2026-09-02 | 3022 | A negative control cannot show that an instrument works. Proofed, and it passes for one of the two instruments here. |
| 2026-09-02 | 3033 | The quantization does not lose the parameter, it moves it into the ratio between two lags. |
| 2026-09-02 | 3051 | A quantity that fails to conserve under a change that should not move it indicates the instrument and not the domain. Proofed as a battery, and it earns its keep. |
| 2026-09-02 | 3067 | The wrong expectation. |
| 2026-09-02 | 3075 | The symbol width has to match the scale of the structure being looked for. Proofed and refined, and it corrects two earlier diagnoses. |
| 2026-09-04 | 3094 | Derivative work should sit closer to the center than original work does, and that is a different claim from the human signature this document refuted. Posited and untested. |
| 2026-09-04 | 3114 | Why the nearest measurement here does not settle it either way. |
| 2026-09-04 | 3123 | It is not a claim about text. |
| 2026-09-04 | 3153 | A reading is undetermined until its partition is fixed, in any dimension and in any state, and a partition is fixed in one of three ways. |
| 2026-09-04 | 3175 | Where this already exists. |
| 2026-09-04 | 3196 | The confound that would produce a false result, also from this document. |
| 2026-09-04 | 3204 | What would settle it, and the design is already in this document. |
| 2026-09-04 | 3214 | A doped lattice is the case where every condition this construction wants is already supplied, and the row that found nothing is the argument for it. Posited and untested. |
| 2026-09-04 | 3229 | The reading inverts too, and that is the part to state before anyone runs it. |
| 2026-09-04 | 3235 | Why the candidate set is closed, which is where Proposition 2 stops binding. |
| 2026-09-04 | 3243 | The reference is not a shuffle, and chemistry already holds what it is. |
| 2026-09-04 | 3250 | What argues against it. |
| 2026-09-04 | 3256 | The order of work, and it is what makes this worth more than an application. |
| 2026-09-04 | 3270 | What it costs, and the arithmetic is free. |
| 2026-09-04 | 3275 | An absence is a reading, which corrects a caveat written here first. |
| 2026-09-04 | 3286 | Where the claim stops. |

**Would change the design**

| day | line | entry |
|---|---|---|
| 2026-09-02 | 3295 | A spatially correlated domain of more than one dimension. |
| 2026-09-02 | 3300 | The mechanism of the product rule failure, since the obvious candidate is refuted. |
| 2026-09-02 | 3310 | Which anchor rule to prefer, as a curve and not two points. |
| 2026-09-02 | 3318 | Whether the memoryless control is enough of a null for the heterogeneity result. |
| 2026-09-02 | 3322 | Whether subject heterogeneity predicts anything about anchor quality. |

**Would change the paper**

| day | line | entry |
|---|---|---|
| 2026-09-02 | 3328 | Baeza-Yates and Régnier, average running time of Boyer-Moore-Horspool, Theoretical Computer Science 92(1):19-31, 1992. |
| 2026-09-02 | 3336 | The filtration literature in approximate string matching, which was the closer prior art and is now read. |
| 2026-09-02 | 3343 | The approximate membership literature, for a contract this work shares and did not invent. |
| 2026-09-02 | 3352 | A structured system that no person produced. |
| 2026-09-02 | 3357 | Lemmatized text. |
| 2026-09-02 | 3361 | A corpus series matched for form and densely sampled. |
| 2026-09-02 | 3366 | The site reports behind Section 4.13.08. |
| 2026-09-02 | 3370 | Separating the count of subjects from the distance between them. |
| 2026-09-02 | 3374 | Section 7.2 and Section 7.3 are in the wrong order in the paper. |

**Read, and what it cost**

| day | line | entry |
|---|---|---|
| 2026-09-02 | 3380 | Vishkin's dueling paradigm and deterministic sampling, from Neuburger's survey. |
| 2026-09-02 | 3384 | What that citation should not be stretched to cover. |
| 2026-09-04 | 3393 | Jaynes, Information Theory and Statistical Mechanics, Physical Review 106(4):620-630, May 15 1957. |
| 2026-09-04 | 3401 | What the reading corrected. |
| 2026-09-04 | 3407 | Jaynes, Information Theory and Statistical Mechanics II, Physical Review 108(2):171-190, October 15 1957. |
| 2026-09-04 | 3419 | Navarro, A Guided Tour to Approximate String Matching, ACM Computing Surveys 33(1):31-88, 2001. |
| 2026-09-04 | 3432 | The lemma is older than the survey and the survey says so. |
| 2026-09-04 | 3436 | What the reading cost, and what survives it. |
| 2026-09-04 | 3445 | The wider version of the same correction. |
| 2026-09-02 | 3453 | Parrondo, Horowitz and Sagawa, Thermodynamics of information. |
| 2026-09-02 | 3459 | The Sproat and Rao exchange on entropy and the Indus script, all four items in full. |
| 2026-09-02 | 3468 | What that reading cost. |
| 2026-09-02 | 3478 | Montemurro and Zanette on the entropy of word ordering, PLoS ONE 6(5):e19875, 2011. |
| 2026-09-02 | 3486 | The Natural Semantic Metalanguage prime inventory, read as the published chart of 65. |
| 2026-09-02 | 3494 | The published corpus of cryptographic oracles. |
| 2026-09-02 | 3497 | Comparison against more published entropy estimators. |

**Would change the claim**

| day | line | entry |
|---|---|---|
| 2026-09-02 | 3502 | A genuinely unenumerable alphabet. |
| 2026-09-02 | 3505 | Whether the invariant results are evidence for anything. |
| 2026-09-02 | 3509 | What the surviving statistic actually detects. |

**Outstanding, and not mine to decide**

| day | line | entry |
|---|---|---|
| 2026-09-02 | 3518 | Making `ancorae` instantiable. |
| 2026-09-02 | 3523 | The praet and DMA integration. |
| 2026-09-02 | 3527 | Audience for the paper. |
...
**That reference is necessarily memoryless, which is why the memoryless control returns 1.00 and is
not a baseline anybody chose.** Among all joint distributions with given marginals, the product
distribution has the maximum entropy. So where the only constraints are single symbol frequencies, the
maximizer factorizes: the positions are independent. Memoryless follows from the construction and is
not an assumption added to it.

The controls in this document therefore are the reference, written out as data. Ten memoryless arms
sit between 0.99 and 1.01 and never leave, and a memoryless corpus returns 1.00 because its distance
from the reference is zero by construction. Reading those rows as a baseline that happens to sit near
one understates what they are.

The corollary is the other half of a loop this document already writes from the far end. If the
reference is independence, a departure from it is a dependence between positions, which is mutual
information. The product rule entry measures exactly that and says so: anchors surviving together more
often than the product of their rates is mutual information between their positions, at a median of
3.55 on English prose, which is 1.8 bits, and a maximum over 60 needles of 490336, which is 18.9. The
deduction here and that measurement are one statement approached from two directions.

**The permutation null and the memoryless control are not the same object, and the difference is
finite sample.** A shuffle draws uniformly from the arrangements of a fixed multiset, which preserves
every count exactly and makes the positions exchangeable. A memoryless source draws independently with
those marginals, which fixes the counts only in expectation. The two agree in the limit and differ at
...
**The same test runs at every window and does not stop where the estimator breaks.** Halving the window
...
The center of mass of the field is the constant the arrangement varies about, so pulling the anchor toward it
...
mean. Both are readings of the residual; every mechanism in the losing table is a reading of the center or
a memory of it.
...
angles are the invariant a molecule is held to, so the deviation is available without having to be
...
language varies about, and flattening it out leaves what the text is about. Where the substrate hands over
...
**The scope stated as limits, which is the form a reader should be handed.** Four of them and no
others. It needs an instantiated object: a sample, a record or a measurement, and never a thing
suspected of existing. It needs that object partitioned into parts, by a partition stipulated,
estimated or supplied. It reads one quantity, the distance from the constrained maximum entropy
reference. And it adds nothing, since the arithmetic supplies no knowledge and the constraint carries
all of it.

The rows that found nothing sit inside those limits and not outside them. A memoryless corpus at 1.00,
the digits of the square root of two at 1.00, a lattice carrying random values at 0.690 against 0.684
and 0.553, and the protein nulls that do not delete separable properties are four objects that
existed, were partitioned, and were correctly reported as carrying nothing this instrument can see.

**What the limits do not exclude is an absence.** Reporting that something expected is missing needs
no new object, because a hole is a departure from an occupancy the constraint already states. The
oracle check's second direction is that reading: it asks which tokens a paper prints that no row
holds, and finds what a person skipped by knowing what should have been there. The regularity is what
makes the hole visible, and a domain with no stated regularity has no holes to find.
...
center.** A detector aimed at humanity directly is aimed at the central value itself, and this document
...
both are constants that something varies about, and neither is ever read.
...
mass again, so what remains in that field is the residual. Whether that residual identifies the speaker has
...
domain varies about, it carries no arrangement information, and a mechanism that moves toward it has nothing
...
until a scale is chosen there is no reading to have. That choice is a declaration,
...
**The order of work, and it is what makes this worth more than an application.** Published atom probe
datasets carry their process conditions with them: implant dose, anneal temperature, the distribution
the process was meant to produce. That is a corpus in the sense this work already uses the word, an
outside body with the answer attached, standing to a doped lattice as the Salishan hand extractions
stand to a paper. So the first run is not a prediction. It is a validation against material whose
doping is already known, and only material that clears it earns a prediction on material that is not.

That order matters more here than anywhere else in this document, because of what the permutation null
measure lacks. The two instruments entry records that the shift agreement detector has external ground
truth three times over from published cell edges, while the permutation null measure carries most of
the findings and has only been shown not to invent structure on memoryless input. A published doping
dataset would be its first positive control with an answer from outside. That is the largest single
gap in this work, and this is a route to closing it.

**What it costs, and the arithmetic is free.** The method needs atomic positions carrying species
labels, which means atom probe tomography or aberration corrected microscopy. That is expensive,
partly destructive, and samples a small volume. Every figure above comes free once the point cloud
exists, and obtaining the point cloud is the whole of the expense.

**An absence is a reading, which corrects a caveat written here first.**
A vacancy is a known site holding nothing, and an antisite is a known site holding the wrong species.
Both are questions about occupancy over an enumerated list, which is the case this posit is strongest
on. An earlier draft of the paragraph below grouped them with the defects that defeat it, and that was
backwards: the regularity of the lattice is what makes a hole visible, because a hole is only a hole
against a structure that says what should have been there.

The same move is already load bearing elsewhere in this document under another name. Direction two of
the oracle check asks which tokens a paper prints that no row holds, and finds omissions by knowing
what should be present. Absence detection is that check applied to a lattice.

**Where the claim stops.** Dislocation cores, grain boundaries and strain fields put atoms off the
ideal lattice and into a continuum, and those are frequently the defects that matter most. The closed
candidate set holds for occupancy of an enumerated site list, vacancies and antisites included, and
fails for the structures that leave the list.
...
publisher's own tokened link. This is a paywall, and retrying it will not open it.
