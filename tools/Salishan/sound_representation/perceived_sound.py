...
# against the speaker's own range, the movement of that pitch, and voicing, and it holds
...
# The window. 32 ms holds three periods of a 100 Hz voice, which the autocorrelation below
...
def prosody_code(measured):
    ...
    Relative to their own range and not to an absolute. A low voice and a high voice saying one
