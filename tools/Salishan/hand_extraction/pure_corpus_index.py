...
#
#   Usage:  python tools/Salishan/hand_extraction/pure_corpus_index.py
#
...
def main():
    ...
    with io.StringIO() as handle:
        ...
        handle.write("**Scope:** every `.oracle.tsv` in the closed corpus, which reaches this "
                     ...
                     "`tools/maintain/private_sync.py`\n\n")
        ...
        handle.write("Written by `tools/Salishan/hand_extraction/pure_corpus_index.py` "
