...
#
#   Usage:  python tools/Salishan/anchor_sift_algorithmic_extraction/sift_extract.py
#
...
# rest of this directory exists to avoid exactly that.
#
...
def main():
    ...
    for path in sorted(glob.glob(os.path.join(PAPERS, "*.txt"))):
        ...
        with open(target, "w", encoding="utf-8", newline="") as handle:
            ...
            handle.write("# Written by tools/Salishan/anchor_sift_algorithmic_extraction/sift_extract.py. No reader has been written\n")
