...
#
#   Usage:  python tools/Salishan/corpus_derivation.py
#
# Run after every change to a hand extraction. This file reads the checks, computes a bound on the
# per-line error rate of the pure corpus, and rewrites docs/research/Salishan/corpus-derivation.md.
#
...
TARGET = os.path.join(ROOT, "theory", "Salishan", "chapters",
                      "chapter_Salishan_corpus_derivation.tex")
...
def main():
    ...
    with io.StringIO() as handle:
        ...
        handle.write("**Scope:** `tools/Salishan/corpus_derivation.py`, which writes this "
                     "file, and the three checks it reads.\n\n")
        handle.write("Rewritten by `python tools/Salishan/corpus_derivation.py` after "
        ...
        handle.write("`tools/Salishan/word_web/word_web.py` joins every form in the hand "
        ...
        handle.write("**Generated by:** `tools/Salishan/corpus_derivation.py`\n")
