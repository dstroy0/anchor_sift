...
#
#   Usage:  python tools/Salishan/corpus_script_extraction/salish_corpus.py
#
...
#
# The second witness is there for that. The repair is applied to both sections independently and the
