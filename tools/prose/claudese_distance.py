...
#
#   Usage:  python tools/prose/claudese_distance.py [--worst N]
#
...
#
# tools/prose/fixtures/claudese_reference.md is the other pole. It is a page written deliberately
...
def main():
    ...
    if os.path.isfile(SESSION):
        ...
        out.write("  no assistant pole. Run tools/corpora/fetch_claude_prose.py\n")
        out.flush()
        return 1
