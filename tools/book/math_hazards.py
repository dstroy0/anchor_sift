...
#
#   Usage:  python tools/book/math_hazards.py docs/research/anchor-sift-method.md [more.md]
#
...
# look, and a hit is a hazard instead of a proven failure, since which of these break depends on the
...
# Checks that read a whole line instead of one math span
LINE_CHECKS = (
    (odd_inline_dollars,
     "an odd number of inline $ on the line, which leaves a formula unclosed"),
)
