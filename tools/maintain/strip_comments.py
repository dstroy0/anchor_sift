...
What is preserved:
  ...
  - the line count of block comments, which keeps a compiler error pointing at the right line

Usage:
    python tools/maintain/strip_comments.py PATH [PATH ...]      # dry run: report only
    python tools/maintain/strip_comments.py PATH --go            # rewrite in place
