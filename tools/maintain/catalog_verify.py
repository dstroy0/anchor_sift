...
#
#   python tools/maintain/catalog_verify.py            every check
#   python tools/maintain/catalog_verify.py --quiet    only the files with a finding
#
...
def theory_sections():
    ...
    for base, dirs, names in os.walk(theory):
