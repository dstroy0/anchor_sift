...
#
#   Usage:  python tools/corpora/fetch_modern_corpora.py [documents per language]
#
...
class HttpRanged(io.RawIOBase):
    ...
    Parquet is read back to front: the footer gives the schema and the offset of each row group. A
