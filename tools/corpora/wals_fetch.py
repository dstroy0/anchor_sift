...
# against many languages, for Section 4.13 of docs/research/anchor-sift.md.
#
#   Usage:  python tools/corpora/wals_fetch.py
#
...
def main():
    ...
    # The features this claim is about, found by name, which keeps a renumbering from breaking it
